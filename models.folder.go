...
var folderList = []folder{
	{Owner: "nna24ga9zn2haa", FolderName: "terns", FolderNameURL: url.QueryEscape("terns"),
		Created: time.Date(2009, 11, 17, 20, 34, 58, 651387237, time.UTC), NumElements: 12,
		Completed: false, Downloaded: false},
	{Owner: "plabs42yabn6sd", FolderName: "2014 Milan", FolderNameURL: url.QueryEscape("2014 Milan"),
